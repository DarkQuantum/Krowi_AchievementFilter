...
L["Already /loved for achievement"] = "Уже /полюбили для {forAchievement}"
L["Already completed for achievement"] = "Уже завершили для{forAchievement} "
L["Already cooked for achievement"] = "Уже приготовили для{forAchievement} "
L["Already defeated for achievement"] = "Уже победили для {forAchievement} "
L["Already drank for achievement"] = "Уже выпили для {for Achievement} "
L["Already eaten for achievement"] = "Уже попробывали для {forAchievement} "
L["Already killed for achievement"] = "Уже убили для {forAchievement} "
L["Already petted for achievement"] = "Уже погладили для {forAchievement} "
L["Alt"] = "Альт "
L["Always Show Completed"] = "Показывать выполненные достижения"
L["Always show realm"] = "Всегда показывать мир"
L["Always show realm Desc"] = "Всегда показывать мир вашего персонажа, не зависимо на каком персонаже любого мира вы находитесь сейчас."
L["Andurs"] = "Андур  "
